      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 pt-12 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-sm leading-6 text-muted-foreground max-w-xs">
              Empowering farmers and FPOs with localized market intelligence, price discovery, and direct verified buyer transactions.
            </p>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex items-start gap-3 group">
                ...
                <a
                  href="mailto:support@agrilink.in"
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-6">
              AgriLink is open source and community driven. Contributions are always welcome 🌱
            </p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-sm text-muted-foreground text-center md:text-left">
            © {currentYear} AgriLink — AI-Powered Farmer Market Intelligence & Direct Buyer Platform 🌾
          </p>
