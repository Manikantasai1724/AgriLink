...
export default function ProductDetails() {
  ...
  const generatePDFReport = () => {
    ...
    doc.text("AGRILINK - LOT TRACEABILITY & CUSTODY REPORT", margin, 16);
    ...
    doc.text(`Report Generated: ${new Date().toLocaleString()}  |  AgriLink Verifiable Ledger System`, margin, doc.internal.pageSize.getHeight() - 10);
    
    doc.save(`AgriLink-Traceability-${product.batchId || product.id}.pdf`);
  };
